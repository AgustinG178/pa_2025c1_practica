...
from modules.modelos import Base,ModeloReclamo,ModeloUsuario
...
class TestGestorUsuarios(unittest.TestCase):
    ...
    def test_crear_usuario(self):
        ...
        self.gestor_usuario.registrar_nuevo_usuario(nombre="Juan", apellido="Perez", email="juan@gmail.com", nombre_de_usuario="juanperez", password="1234", rol=0, claustro=0,id=1)

        #Verificamos que el usuario se haya guardado correctamente

        usuario_db = self.repo_usuarios.obtener_registro_por_filtro(campo="id",valor=1) #en este caso conocemos el id, pero es solo para verificar el funcionamiento del método
